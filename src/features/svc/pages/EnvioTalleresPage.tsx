/**
 * Envío a Talleres SVC — Lista/filtro de órdenes (ej. tipo taller_externo). Solo lectura.
 * Consume GET /svc/ordenes-servicio con filtros.
 */
...
export default function EnvioTalleresPage() {
  ...
  const [tipoFilter, setTipoFilter] = useState<string>('taller_externo');
  ...
  return (
    <SvcPageLayout
      title="Envío a Talleres"
      description="Órdenes de servicio vinculadas a talleres externos (listado y filtros)."
    >
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 shadow">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
              {list.length === 0 ? (
                <tr><td colSpan={7} className="px-4 py-8 text-center text-gray-500 dark:text-gray-400"><Truck className="h-10 w-10 mx-auto mb-2 opacity-50" />No hay órdenes con los filtros seleccionados.</td></tr>
              ) : (
                list.map((row) => (
