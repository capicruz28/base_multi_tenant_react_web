...
// ============================================
// TIPOS PARA ALERTAS DE MÓDULOS
// ============================================

export interface ModuloAlerta {
  tipo: 'vencido' | 'vencimiento_proximo' | 'limite_usuarios' | 'limite_registros' | 'conexion_error';
...
/** @deprecated Use ModuloActivo instead */
export type ModuloActivacion = ModuloActivo;

/** @deprecated Use ModuloActivoConEstadisticas instead */
export type ModuloEstadisticas = ModuloActivoConEstadisticas;

// Note: ConexionEstado is an alias for Conexion from conexion.types
// Import Conexion directly from conexion.types when needed
