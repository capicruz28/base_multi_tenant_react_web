    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <Shield className="mx-auto h-12 w-12 text-text-soft" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-surface rounded-lg shadow-sm border border-border-base p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-soft">Total Plantillas</p>
              <p className="text-2xl font-semibold text-text-base">{totalPlantillas}</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-surface rounded-lg shadow-sm border border-border-base overflow-hidden">
        ...
        {loading && (
          <div className="flex items-center justify-center py-8">
            ...
            <span className="ml-2 text-text-soft">Cargando plantillas...</span>
          </div>
        )}
                ...
                <tbody className="bg-surface divide-y divide-border-base">
                  {plantillas && plantillas.length > 0 ? (
                    plantillas.map((plantilla) => {
                      ...
                      return (
                        <tr key={plantilla.plantilla_rol_id} className="hover:bg-overlay/50 dark:hover:bg-overlay/50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex justify-end items-center gap-2">
                              ...
                              <button
                                ...
                                className={`p-1 rounded hover:bg-overlay dark:hover:bg-overlay ${plantilla.es_activa
