// src/features/admin/services/area.service.ts
...
export const updateArea = async (areaId: string, areaData: AreaUpdateData): Promise<Area> => {
  try {
...
export const deactivateArea = async (areaId: string): Promise<Area> => {
  try {
    // ✅ CAMBIO: Ya tiene / al final - OK
...
export const reactivateArea = async (areaId: string): Promise<Area> => {
  try {
    // ✅ CAMBIO: Ya tiene / al final - OK
