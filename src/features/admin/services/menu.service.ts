import api from '@/core/api/api'; // Instancia centralizada de Axios con interceptores
import type {
...
export const menuService = {
   ...
   */
  deactivateMenuItem: async (menuId: string): Promise<Record<string, any>> => { // Devuelve el objeto de respuesta del backend
    const endpoint = `/menus/${menuId}/`; // <-- agregado /
    try {
   ...
   */
  reactivateMenuItem: async (menuId: string): Promise<Record<string, any>> => { // Devuelve el objeto de respuesta del backend
