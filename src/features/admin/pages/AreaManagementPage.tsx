// src/features/admin/pages/AreaManagementPage.tsx

import React, { useState, useEffect, useCallback, ChangeEvent, FormEvent } from 'react';
import { toast } from 'react-hot-toast';
// --- Importar servicios y tipos de ÁREAS ---
import { getAreas, createArea, updateArea, deactivateArea, reactivateArea } from '../services/area.service';
import { Area, PaginatedAreaResponse, AreaCreateData, AreaUpdateData } from '../types/area.types';
// --- Importar servicios y utilidades comunes ---
import { Loader, Edit3, Plus, Search, EyeOff, Eye } from 'lucide-react';
...
// Note: cliente_id will be added dynamically from auth context
type AreaCreateFormData = Omit<AreaCreateData, 'cliente_id'>;
const initialCreateFormData: AreaCreateFormData = { nombre: '', descripcion: '', icono: '', es_activo: true };
...
const AreaManagementPage: React.FC = () => {
  ...
  const [newAreaFormData, setNewAreaFormData] = useState<AreaCreateFormData>(initialCreateFormData); // <--- Cambiado
