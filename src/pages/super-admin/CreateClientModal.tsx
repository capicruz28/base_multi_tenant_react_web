...
import { X, Building, CheckCircle, XCircle, Loader } from 'lucide-react';
...
const CreateClientModal: React.FC<CreateClientModalProps> = ({
  ...
  // Validar subdominio cuando cambie
  useEffect(() => {
    const validateSubdomain = async () => {
      ...
      try {
        const result = await clienteService.validateSubdominio();
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.subdominio.trim()) {
      ...
      newErrors.subdominio = 'Este subdominio no está disponible';
    }
