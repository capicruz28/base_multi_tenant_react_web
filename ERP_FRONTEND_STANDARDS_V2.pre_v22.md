...
**Versión:** 2.1  
**Fecha:** 10 junio 2026  
**Estado:** **Normativo** — post-cierre IAM · ORG · INV · incorporación modales/acciones fila ORG+INV · extensiones v2.1 ERP-BL-ACT-01 (jun 2026)  
...
**Extensiones v2.1 (jun 2026, sin bump de versión):** ERP-BL-ACT-01 (§6.3.1 PB-15…PB-21), UX-09, SEC-11…SEC-13, cierre INV-UX-003/004. Consolidación formal **v2.2** diferida hasta cierre UX-006, UX-007 y auditorías abiertas.
...
*Documento normativo V2.1 — write once. `.cursorrules` y PROMPT referencian IDs; no redefinen reglas.*
